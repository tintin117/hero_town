...
func _balance_edits() -> void:
	var edited = load("res://conquest/default_balance.tres").duplicate(true)
	...
	var rules_script = load("res://conquest/conquest_state.gd")
...
func _menu_edits() -> void:
	var companion_template = load("res://conquest/companion.tscn").instantiate()
	...
	var edited = load("res://scenes/main_menu.tscn").instantiate()
...
func _companion_edits() -> void:
	var edited = load("res://conquest/companion.tscn").instantiate()
...
func _worker_edits() -> void:
	var edited = load("res://conquest/town_workers.tscn").instantiate()
...
func _sparring_edits() -> void:
	var edited = load("res://conquest/taskbar_sparring.tscn").instantiate()
...
func _remaster_edits() -> void:
	...
	var unit_template = load("res://scenes/remaster/unit_view.tscn").instantiate()
	...
	var building_template = load("res://scenes/remaster/town_building.tscn").instantiate()
	...
	var edited = load("res://scenes/town_2d.tscn").instantiate()
