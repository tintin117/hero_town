extends SceneTree
const Companion = preload("res://game/companion/companion.tscn")
var failures := 0
var checks := 0
...
func run_checks() -> void:
	...
	c.save_path = "res://.godot/test_outputs/companion-check-save.json"
	...
	var expected_width: int = load("res://game/shared/presentation_scale.gd").window_width(root)
	...
	if DisplayServer.get_name()!="headless":
		...
		root.get_texture().get_image().save_png("res://.godot/test_outputs/companion-training.png")
	...
	c.persist()
	var restored = load("res://game/companion/conquest_state.gd").new()
	...
	if DisplayServer.get_name()!="headless":
		...
		img.save_png("res://.godot/test_outputs/companion-battle.png")
	...
	if DisplayServer.get_name()!="headless":
		await RenderingServer.frame_post_draw
		root.get_texture().get_image().save_png("res://.godot/test_outputs/taskbar-sparring.png")
	...
	root.remove_child(c)
	c.free()
	DirAccess.remove_absolute("res://.godot/test_outputs/companion-check-save.json")
