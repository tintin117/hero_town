...
Keep Embed Game on Play disabled for native companion mode. To review without touching player progress, run res://game/previews/town_preview.tscn; it creates temporary demonstration armies and mutes audio. Normal play remains game/menu/main_menu.tscn. Landscape selection is in Options.
