...
> **Superseded by the remaster.** Building research, all four armies, wave battles, bosses, saving, and offline gold are now implemented in the active entry scenes. See [REMASTER.md](../TOWN.md). The diagrams below describe the earlier prototype.
