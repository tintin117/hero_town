...
func _ready() -> void:
	HEROES = _load_dir("res://data/town/heroes/")
	ENEMIES = _load_dir("res://data/town/enemies/")
	BUILDINGS = _load_dir("res://data/town/buildings/")
	RESEARCH = _load_dir("res://data/town/research/")
	for number in range(1, 21):
		STAGES[number] = load("res://data/town/stages/stage_%02d.tres" % number)
